...
model = Sequential()
model.add(SimpleRNN(128, input_shape=(None, len(train_x[0])), activation="relu"))
...
train_x = np.reshape(train_x, (len(train_x), 1, len(train_x[0])))
hist = model.fit(np.array(train_x), np.array(train_y), epochs=200, batch_size=5, verbose=1)
model.save("chatbot_modelz.h5", hist)
print("model created")
